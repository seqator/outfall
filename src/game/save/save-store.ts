...
/** Версии форматов, под ключами которых `load()` ищет сейв, если под текущим ключом ничего нет — от новой к старой, чтобы не подхватить случайно совсем древний формат раньше актуального. */
const KNOWN_SAVE_VERSIONS: readonly number[] = [2, 1];
